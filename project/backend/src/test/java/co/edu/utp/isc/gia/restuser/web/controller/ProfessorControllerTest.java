...
public class ProfessorControllerTest {
   ...
   @Test
    ...
    public void testSaveProfessorInvalidPropertiesIdCardEmailAndPassword() {
        ...
        ProfessorDto professor = new ProfessorDto(null, "number", "50Juan", 
                "50Gomez", "invalidEmail.co", "45Janco", "123");
    ...
    public void testSaveProfessorInvalidPasswordAndIdCard() {
        ...
        ProfessorDto professor = new ProfessorDto(null, "01number", "Juan", 
    ...
    public void testSaveProfessorValidInfo() {
        Professor savedProfessor = new Professor(1L,"11","Juan carlos", "Gomez", 
                "juant@me.co", "Janco27", "Juanavid", null);
        when(professorRepository.save(any(Professor.class))).thenReturn(savedProfessor);
        
        ProfessorDto inputProfessorDto = new ProfessorDto(null,"11","Juan carlos", "Gomez", 
   ...
   @Test
    ...
    public void testUpdateProfessorInvalidPropertiesIdCardEmailAndPassword() {
        ...
        ProfessorDto professor = new ProfessorDto(0L, "number", "Juan", 
                "Gomez", "emaildomain.co", "45Janco", "123");
    ...
    public void testUpdateProfessorInvalidPasswordAndIdCard() {
        ...
        ProfessorDto professor = new ProfessorDto(1L, "01number", "Juan", 
                "Gomez", "invalid@Emailco", "Janco", "123as");
    ...
    public void testUpdateProfessorValidInfo() {
        Professor savedProfessor = new Professor(1L,"11","Juan(edited)", "Gomez(edited)", 
                "juan@domain.co", "Janco27", "password", null);
        when(professorRepository.save(any(Professor.class))).thenReturn(savedProfessor);
        
        ProfessorDto inputProfessorDto = new ProfessorDto(1L,"11","Juan(edited)", "Gomez(edited)", 
                "juan@domain.co", "Janco27", "password");

        ProfessorDto outputProfessorDto = new ProfessorDto(1L,"11","Juan(edited)", "Gomez(edited)", 
                "juan@domain.co", "Janco27", "password");
    ...
    */
    ...
    public void testFindOne() {
        ...
        ProfessorDto professorDtoOutput = new ProfessorDto(1L,"11","Juan carlos", "Gomez", 
                "juant@me.co", "Janco27", "Juanavid");
    ...
    */ 
    ...
    public void testListAll() {
        ...
        professors.add(new Professor(1L,"11","Juan carlos", "Gomez", 
                "juant@me.co", "Janco27", "Juanavid", null));
        professors.add(new Professor(2L,"12","Carlos mario", "Lopez", 
                "carlos@me.co", "Carl727", "Carlosthebest", null));
        professors.add(new Professor(3L,"13","Natalia", "Castano", 
        ...
        professorsDto.add(new ProfessorDto(1L,"11","Juan carlos", "Gomez", 
                "juant@me.co", "Janco27", "Juanavid"));
        professorsDto.add(new ProfessorDto(2L,"12","Carlos mario", "Lopez", 
                "carlos@me.co", "Carl727", "Carlosthebest"));
        professorsDto.add(new ProfessorDto(3L,"13","Natalia", "Castano", 
